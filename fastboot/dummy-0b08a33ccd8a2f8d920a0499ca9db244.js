  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    ...
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        dom.setAttribute(el5, "href", "https://github.com/pzuraq/liquid-tether");
  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    ...
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        dom.appendChild(el0, el1);
        var el1 = dom.createElement("p");
        var el2 = dom.createTextNode("The stack name will be applied as the id to the tethers, allow you to match them using\nthe ");
        dom.appendChild(el1, el2);
        var el2 = dom.createElement("code");
...
define('dummy/config/environment', ['ember'], function(Ember) {
  var exports = {'default': {"modulePrefix":"dummy","podModulePrefix":"dummy/pods","environment":"production","baseURL":"/","locationType":"hash","EmberENV":{"FEATURES":{}},"contentSecurityPolicy":{"default-src":"'none'","script-src":"'self'","font-src":"'self' https://maxcdn.bootstrapcdn.com","connect-src":"'self'","img-src":"'self'","style-src":"'self' 'unsafe-inline' https://maxcdn.bootstrapcdn.com","media-src":"'self'"},"APP":{"name":"liquid-wormhole","version":"2.0.0-beta.2+93aaa33f","autoboot":false},"rootURL":"/liquid-tether","exportApplicationGlobal":false}};Object.defineProperty(exports, '__esModule', {value: true});return exports;
});
